  ...
  static NPC createAdamWeishaupt() => createAlphonse().copyWith(
    ...
    abilities: const [
      Ability(
        ...
        name: 'Rationalist Re-education',
        type: AbilityType.special,
        chargeTime: 14.0,
        description: 'Forces enemy units in a radius to drop their weapons and read prescribed doctrines, reducing their damage by 50% for 6s under the direction of the Order',
      ),
      Ability(
        id: 'superiors_direction',
        name: "Superiors' Direction",
        type: AbilityType.special,
        chargeTime: 18.0,
        description: 'Prescribes in great detail everything which nearby friendly units must read and think, boosting their attack speed by 60% but making them take 20% more damage due to absolute obedience',
      ),
    ],
  );
